...
public class Menu extends JMenuBar implements ActionListener {
    ...
    public Menu(Gui gui) {
		 ...
		 * exportAnswers.getAccessibleContext().
		 * setAccessibleDescription("Exports answers to a file");
		 * exportAnswers.addActionListener(this); fileMenu.add(exportAnswers);
		 */
		 ...
		 * mailFeedback.getAccessibleContext().
		 * setAccessibleDescription("Sends feedback emails to students");
		 * mailFeedback.addActionListener(this); fileMenu.add(mailFeedback);
		 */
