...
public class StructureToolBar extends JToolBar implements ActionListener {
    ...
    public StructureToolBar(SheetStructureEditor sheetView) {
        ...
        // Select
        selectButton = makeToolbarButton("images/select.png", "select", "Select", "Select");
        
        // Question group
        questionsButton = makeToolbarButton("images/questions.png", "question", "Add question groups", "Questions");
        
        // Registration
        registrationButton = makeToolbarButton("images/align.png", "registration", "Add registration markers", "Registration");
